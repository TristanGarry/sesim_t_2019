...
i7.9  = spinter
i7.10 = spinter
i7.11 = spinter -o*(Euplotes / Colpidium)^p
i7.12 = spinter -o*(Blepharisma / Colpidium)^p
...
i8.9  = spinter
i8.10 = spinter
i8.11 = spinter -o*(Euplotes / T.pyriformis)^p
i8.12 = spinter -o*(Blepharisma / T.pyriformis)^p
...
i9.9  = spintra
i9.10 = spinter
i9.11 = spinter -o*(Euplotes / Vorticella)^p
i9.12 = spinter -o*(Blepharisma / Vorticella)^p
...
i10.10 = spintra
i10.11 = spinter
i10.12 = spinter -o*(Blepharisma / Monostyla)^p
...
i11.5  = spinter
i11.6  = spinter
i11.7  = spinter + abs(e*(-o*(Euplotes / Colpidium)^p))
i11.8  = spinter + abs(e*(-o*(Euplotes / T.pyriformis)^p))
i11.9  = spinter + abs(e*(-o*(Euplotes / Vorticella)^p))
i11.10 = spinter
i11.11 = spintra
i11.12 = spinter -o*(Blepharisma / Euplotes)^p
...
i12.5  = spinter
i12.6  = spinter
i12.7  = spinter + abs(e*(-o*(Blepharisma / Colpidium)^p))
i12.8  = spinter + abs(e*(-o*(Blepharisma / T.pyriformis)^p))
i12.9  = spinter + abs(e*(-o*(Blepharisma / Vorticella)^p))
i12.10 = spinter + abs(e*(-o*(Blepharisma / Monostyla)^p))
i12.11 = spinter + abs(e*(-o*(Blepharisma / Euplotes)^p))
i12.12 = spintra + abs(e*(-o*(Blepharisma / Blepharisma)^p)) + (-o*(Blepharisma / Blepharisma)^p)
