...
# growth rates
r.source <- c(8.4,  16.8, 20.3, 1.32, 0.92, 1.64, 0.11, 2.63, 0.15, 0.48, 1.78, 1.31)
r.sink   <- c(0.84, 1.68, 2.03, 1.82, 0.16, 1.45, 0,    1.25, 0.77, 1.30, 2.04, 1.32)
# carrying capacity
